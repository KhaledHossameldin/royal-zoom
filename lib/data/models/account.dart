...
class Account {
  ...
  Map<String, dynamic> toMap() {
    ...
    return {
      ...
      contract.lastLoginAt: lastLoginAt?.millisecondsSinceEpoch,
      contract.emailVerifiedAt: emailVerifiedAt?.millisecondsSinceEpoch,
      contract.phoneVerifiedAt: phoneVerifiedAt?.millisecondsSinceEpoch,
