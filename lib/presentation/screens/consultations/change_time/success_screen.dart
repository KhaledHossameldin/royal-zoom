...
class ChangeConsultationTimeSuccess extends StatelessWidget {
  const ChangeConsultationTimeSuccess({super.key, required this.id});
              ...
              children: [
                ...
                Text.rich(
                  TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: appLocalizations.dateEditedTitle,
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text(appLocalizations.backToConsultation),
                  ),
                ),
              ],
            ),
