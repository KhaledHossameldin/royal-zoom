...
class ConsultationContentScreen extends StatefulWidget {
  const ConsultationContentScreen({super.key});

  @override
  State<ConsultationContentScreen> createState() =>
      _ConsultationContentScreenState();
}

class _ConsultationContentScreenState extends State<ConsultationContentScreen>
