...
class Dimens {
  ...
  static final horizontalPadding2 = EdgeInsets.symmetric(horizontal: ScreenHelper.fromWidth55(10.0));
  static final defaultPageHorizontalPadding = EdgeInsets.symmetric(horizontal: ScreenHelper.fromWidth55(6.0));
  static final defaultPageHorizontalPaddingSmall = EdgeInsets.symmetric(horizontal: ScreenHelper.fromWidth55(4.0));
